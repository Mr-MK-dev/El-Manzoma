<template>
  <div>
    ...
    >
      ...
      <template v-slot:item.EmploymentState="{ item }">
        <v-chip color="transparent">
          {{ item.EmploymentState ? "تم التوظيف" : "لم يتم التوظيف" }}
        </v-chip>
      </template>
      <template v-slot:item.PapersExist="{ item }">
        <v-chip color="transparent">
          {{ item.PapersExist ? "تم تقديم ورق" : "لم يتم تقديم ورق" }}
        </v-chip>
      </template>
    </table-bulider>
