  ...
  <div>
    ...
    >
      <template v-slot:item.edit="{ item }">
        <v-chip color="transparent" @click="deleteHospital(item)">
...
export default {
  ...
  methods: {
    ...
    async saveItem(edirableFromTableItem) {
      ...
      try {
        saveItem = await this.api(
          !this.hospital.ID_KEY ? `global/create_one` : `global/update_one`,
          {
            table: "Hospital",
            where: !this.hospital.ID_KEY
              ? this.hospital
              : {
                  ID_KEY: this.hospital.ID_KEY
                },
    ...
    actionAdd() {
      this.$set(this, "hospital", { isEdit: false });
