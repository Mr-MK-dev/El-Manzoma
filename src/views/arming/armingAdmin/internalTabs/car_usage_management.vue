<template>
  <div>
    ...
    <table-bulider
      ...
      :title="'استخدامات المركبات'"
    >
      <template v-slot:item.edit="{ item }">
        <v-chip color="transparent" @click="deleteCarUsage(item)">
...
<script>
export default {
  name: "car_usage_management",
  mounted() {
    this.findAllCarUsages();
  },
  data: () => ({
    del: {
      loading: false,
