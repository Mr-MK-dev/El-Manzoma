<template>
  <div>
    ...
    <table-bulider
      ...
      :title="'حمولات المركبات'"
    >
      <template v-slot:item.edit="{ item }">
        <v-chip color="transparent" @click="deleteCarCargo(item)">
...
<script>
export default {
  name: "car_cargo_management",
  mounted() {
    this.findAllCarCargos();
  },
  data: () => ({
    del: {
      loading: false,
