<template>
  <div>
    ...
    <table-bulider
      ...
      :title="'انواع المركبات'"
    >
      <template v-slot:item.edit="{ item }">
        <v-chip color="transparent" @click="deleteCarType(item)">
...
<script>
export default {
  name: "car_type_management",
  mounted() {
    this.findAllCarTypes();
  },
  data: () => ({
    del: {
      loading: false,
