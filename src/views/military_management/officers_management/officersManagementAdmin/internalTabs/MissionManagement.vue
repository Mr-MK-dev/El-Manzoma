...
export default {
  ...
  methods: {
    ...
    async saveItem(edirableFromTableItem) {
      ...
      try {
        saveItem = await this.api(
          !this.missions.ID_KEY ? `global/create_one` : `global/update_one`,
          {
            table: "Missions",
            where: !this.missions.ID_KEY
              ? this.missions
              : {
                  ID_KEY: this.missions.ID_KEY
                },
            update: this.missions
          }
        );
    ...
    actionAdd() {
      this.$set(this, "missions", { isEdit: false });
