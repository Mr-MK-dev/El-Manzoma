...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      {
        text: "اقل درجة ممكنة للوحدة",
        value: "minimumDegree",
        searchValue: "minimumDegree",
        sortable: true,
        type: "select",
        inSearch: false,
        inTable: true,
      ...
      {
        text: "اعلى درجة ممكنة للوحدة",
        value: "maximumDegree",
        searchValue: "maximumDegree",
        sortable: true,
        type: "select",
        inSearch: false,
        inTable: true,
      ...
      this.api("global/get_all", {
        ...
        .then(x => {
          let data = x.data.map(ele => ({
              ...ele,
              isSpecial: ele.isSpecial ? 1 : 0,
              isHardWork: ele.isHardWork ? 1 : 0,
              isSpecialText: ele.isSpecial ? "نعم" : "لا",
              isHardWorkText: ele.isHardWork ? "نعم" : "لا",
              extraProfitTypeText: this.selects.extraProfitType.data.find(
                e => e.value == ele.extraProfitType
              )?.text
            })),
            printer = {
              cons: [...data],
