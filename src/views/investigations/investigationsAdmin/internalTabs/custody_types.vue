...
export default {
  ...
  methods: {
    ...
    async saveItem(edirableFromTableItem) {
      ...
      try {
        saveItem = await this.api(
          !this.custodyType.ID_KEY ? `global/create_one` : `global/update_one`,
          {
            table: "CustodiesType",
            where: !this.custodyType.ID_KEY
              ? this.custodyType
              : {
                  ID_KEY: this.custodyType.ID_KEY
                },
            update: this.custodyType
          }
        );
    ...
    actionAdd() {
      this.$set(this, "custodyType", { isEdit: false });
