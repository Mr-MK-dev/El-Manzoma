      ...
      try {
        ...
        for (const unit of unites.data) {
          ...
          items.push({
            ...
            transfered: this.items.filter(ele => ele.OldUnitID === unit.UnitID)
              .length,
            ...
            after:
              rateb.data.length -
              this.items.filter(ele => ele.OldUnitID === unit.UnitID).length +
              this.items.filter(ele => ele.TransferedUnitID === unit.UnitID)
                .length
          });
        }
        console.log(items);
