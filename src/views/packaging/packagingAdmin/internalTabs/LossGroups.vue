...
export default {
  ...
  methods: {
    ...
    async saveItem(edirableFromTableItem) {
      ...
      try {
        saveItem = await this.api(
          !this.groups.ID_KEY ? `global/create_one` : `global/update_one`,
          {
            table: "LossGroups",
            where: !this.groups.ID_KEY
              ? this.groups
              : {
                  ID_KEY: this.groups.ID_KEY
                },
            update: this.groups
          }
        );
    ...
    actionAdd() {
      this.$set(this, "groups", { isEdit: false });
